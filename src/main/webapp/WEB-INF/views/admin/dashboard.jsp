                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${quantity.get(1)}</div>
                                    <div>Total User</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${quantity.get(2)}</div>
                                    <div>Total Song</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${quantity.get(0)}</div>
                                    <div>Total Admin</div>
                                </div>
                            </div>
                        </div>
...
<script src="/resources/admin/js/morris-data.js"></script>
